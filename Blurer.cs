using CourseWorkLabunDOTNETCORE.Native;
using System;
...
namespace CourseWorkLabunDOTNETCORE
{
    public class Blurer
    {
        public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached(
            "IsEnabled", typeof(bool), typeof(Blurer),
        ...
        public static readonly DependencyProperty WindowBlurProperty = DependencyProperty.RegisterAttached(
            "WindowBlur", typeof(Blurer), typeof(Blurer),
            new PropertyMetadata(null, OnWindowBlurChanged));

        public static void SetWindowBlur(DependencyObject element, Blurer value)
        {
            element.SetValue(WindowBlurProperty, value);
        }

        public static Blurer GetWindowBlur(DependencyObject element)
        {
            return (Blurer)element.GetValue(WindowBlurProperty);
        }
        ...
        private static void OnWindowBlurChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is Window window)
            {
                (e.OldValue as Blurer)?.Detach();
                (e.NewValue as Blurer)?.Attach(window);
            }
        }
